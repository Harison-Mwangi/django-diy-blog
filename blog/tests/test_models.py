...
class BlogModelTest(TestCase):
    ...
    def test_last_edit_label(self):
        field_label = Blog._meta.get_field('last_edit').verbose_name
    ...
    # custom class methods
    def test_blog_name_is_title(self):        
...
class CommentModelTest(TestCase):
    ...
    # custom class methods
    def test_comment_name_is_first_seventy_five_chars_of_description(self):
